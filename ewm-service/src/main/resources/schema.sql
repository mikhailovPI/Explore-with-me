...
--drop table users_of_events cascade;
...
--    dislikes_id           BIGINT,
    ...
    CONSTRAINT fk_comment_id_events FOREIGN KEY (comment_id) REFERENCES comments (comment_id)
);
...
--(
--  likes_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
--  user_id  BIGINT NOT NULL,
--  event_id BIGINT NOT NULL,
--  CONSTRAINT pk_likes PRIMARY KEY (likes_id),
--  CONSTRAINT fk_event_id_compilation_of_events FOREIGN KEY (event_id) REFERENCES events (event_id),
--  CONSTRAINT fk_comp_id_compilation_of_events FOREIGN KEY (user_id) REFERENCES users (user_id)
--);

--CREATE TABLE IF NOT EXISTS dislikes
--(
--    dislikes_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
--  user_id  BIGINT NOT NULL,
--  event_id BIGINT NOT NULL,
...
--CREATE TABLE IF NOT EXISTS users_of_events
--(
--  user_id  BIGINT NOT NULL,
--  event_id BIGINT NOT NULL,
--  CONSTRAINT fk_event_id_compilation_of_events FOREIGN KEY (event_id) REFERENCES events (event_id),
